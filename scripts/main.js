...
var api_key = 'GFzAFq_-GdGQVYBbI8FQ2-Yxnl6VdWV9';
...
function getCategory(){
	var category_id = sessionStorage.getItem('currentCategoryId');
	$.get('https://api.mongolab.com/api/1/databases/taskmanager/collections/categories/'+category_id+'?apiKey='+api_key, function(data){
